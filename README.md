...
I believe tools are only as good as what you build with them. Here is a look at the languages, frameworks, and environments I use to bring my projects to life—from the web browser to the command line.

### 💻 Frontend
*Crafting responsive and interactive user experiences.*  
![Frontend Skills](https://skillicons.dev/icons?i=ts,js,html,css,react)
...
### 🌐 Networking & Systems
*Understanding how data moves and living in the terminal.*  
